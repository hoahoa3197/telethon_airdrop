...
class AIRDROP:
    ...
    async def main(self):
        ...
        async with self.client:
            ...
            self.userbot = 'NFTMarbleGameAirdropbot'
            self.param_data = ["r0807267747","r06672593280","r02754727080","r01445626680","r01399340570","r06365908580","r02822264580","r00863044580","r00794147780","r06969827080"] #https://t.me/NFTMarbleGameAirdropbot?start=r0807267747
            await self.join_channel('nftmarblegame')
...
def loop_task(proxy_port):
    while True:
        ...
        # tele_path = 'D:\\telegram_with_rand_abi\\+84825543251\\+84825543251.session'
        print(tele_path)
...
workers =[]
proxy_port = [5002,5003,5004,5005,5006,5007,5008,5009,5010,5011,5012,5013,5014,5015] #
