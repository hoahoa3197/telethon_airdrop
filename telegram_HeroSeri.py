...
class AIRDROP:
    ...
    async def main(self):
        ...
        async with self.client:
            ...
            self.userbot = 'HeroSeriAirdropbot'
            ...
            await self.join_channel('heroseri_ann')
            await self.join_channel('heroseri_chat')
            ...
            await self.send_message_to_bot(self.userbot,limit_time=5,keyword='YouTube channel',text = str(twitter_users[index].split("/")[3]))
...
listdir = os.listdir(r'D:\\telegram_partner')       
...
workers =[]
proxy_port = [5001,5002,5003,5004,5005,5006,5007,5008,5009,5010,5011,5012] #
