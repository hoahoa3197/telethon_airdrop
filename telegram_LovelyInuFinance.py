...
class AIRDROP:
    ...
    async def main(self):
        ...
        async with self.client:
            ...
            self.userbot = 'LovelyInuFinanceAirdropbot'
            ...
            await self.join_channel('lovelyinu_coin')
            await self.join_channel('lovelyinu_channel')
            ...
            await self.send_message_to_bot(self.userbot,limit_time=5,keyword='Submit your Instagram profile link',text = 'https://www.instagram.com/'+str(twitter_users[index].split("/")[3]))
