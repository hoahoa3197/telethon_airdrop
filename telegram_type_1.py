...
class AIRDROP:
    ...
    async def main(self):
        ...
        self.client = TelegramClient(self.tele_path,api=api,proxy=("socks5", '192.168.1.5', self.proxy_port))
        async with self.client:
            ...
            self.userbot = 'OrblerRound2AirdropBot'
            self.param_data = ["838671899","1930978915","1937229161","1906782599","1936149068","1921550731","1925554668","1784838891","1945275765","913759907","1103443159"] #
            await self.join_channel('orbler_chat')
            await self.join_channel('orbler')
...
listdir = os.listdir(r'D:\Telegram_partner')       
def loop_task(proxy_port):
    while True:
        ...
        lock.release()
        # try:
        tele_path = 'D:\\Telegram_partner\\' + listdir[index_path] +'\\'+ listdir[index_path]+'.session'
        print(tele_path)
...
workers =[]
proxy_port = [5002,5003,5004,5005,5006,5007,5008,5009,5010,5011,5012,5013] #
