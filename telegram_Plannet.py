...
class AIRDROP:
    ...
    async def main(self):
        ...
        async with self.client:
            ...
            self.userbot = 'BotPlanetAirdropBot'
            # self.param_data = ["838671899"]
            self.param_data = ["838671899","1669520840","1786505889","1716370505","1767186545","1732043675"]

            await self.join_channel('botplanetchat')
            await self.join_channel('botplanetnews')
            ...
            await self.send_message_to_bot(self.userbot,limit_time=10,keyword='enter your twitter username',text = '@'+str(twitter_users[index]))
            await self.click_btn_message(self.userbot,limit_time=10,keyword='Discord group')
